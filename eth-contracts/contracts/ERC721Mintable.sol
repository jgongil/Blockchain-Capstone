...
contract Ownable {
    ...
    //  1) create a private '_owner' variable of type address with a public getter function
     address private _owner;          // Account used to deploy contract
     
    //  5) create an event that emits anytime ownerShip is transfered (including in the constructor)
     event ownershipTransferred(address origOwner, address newOnwer);
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(Address.isContract(newOwner),"The owner must be an EOA");
        require(newOwner != address(0),"The owner cannot be 0");
...
contract Pausable is Ownable {
    ...
    function setPaused(bool mode) public onlyOwner {
        require(_paused != mode, "Contract status already set");
        _paused = mode;
        if (mode) {
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "The address to be approved is already the token owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(owner != msg.sender || isApprovedForAll(owner, to),"Msg sender is not owner or not approved");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_exists(tokenId), "Token cannot be approved because it doesn´t exist");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender); // cannot approve myself
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId) && !Address.isContract(to), "Token already exists or contract/invalid address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_isApprovedOrOwner(from, tokenId), "The from address is not the token owner");
        // TODO: require token is being transfered to valid address
        require(!Address.isContract(to), "Invalid destination address for transfer");
        // TODO: clear approval
...
contract PlatinumERC721Token is ERC721Metadata('Platinum', 'PT', 'https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/') {
